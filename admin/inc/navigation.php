...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-light-dark elevation-4 bg-primary text-white">
        ...
        <img src="<?php echo validate_image($_settings-> info('logo'))?>" alt="" class="uploads/Kosen Logo.jpg" style="opacity: .8;width: 2.5rem;height: 2.5rem;max-height: unset">
        <span class="brand-text font-weight-light">KOSEN</span>
        </a>
        <!-- Sidebar -->
