 ...
 <nav class="navbar navbar-expand-lg navbar-dark fixed-top navbar-shrink" id="mainNav">
            ...
            <div class="logo">
              <img class="logo" src="uploads/Kosen logo.jpg">
                <a class="navbar-brand" href="#page-top"><span class="text-waring">KOSEN</span></a>
            </div>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="<?php echo $page !='home' ? './':''  ?>#itinerary">Itinerary</a></li>
